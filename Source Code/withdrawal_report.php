...
<title>Home Finance | Withdrawal Report</title>
<!-- InstanceEndEditable -->
...
<b><h3>Date</h3></b>
<form action="wi_report.php" method="post">
...
<form action="wi_report.php" method="post">
<button type="submit" name="all" class="form-control alert-danger" value="all">Generate All Withdrawal Records Recorded Upto Date</button>
</form>
</td>
</tr>
</table>
