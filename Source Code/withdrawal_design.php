...
<title>Home Finance | Withdrawal</title>
<!-- InstanceEndEditable -->
...
<?php
if(isset($_SESSION['withdrawal_message']))
{
echo "<center><b class=alert-info><h4>".$_SESSION['withdrawal_message']."</h4></b></center>";
}
?>

<div class="container" style="height:300px; width:500px;">
<form action="store_withdrawal.php" method="post">
...
Amount Withdrawn<input type="text" required name="amount" class="form-control" placeholder="amount??"></br>
<button class="alert-danger form-control" type="reset">Reset</button>
<br />
<button class="alert-info  form-control col-lg-10 " type="submit" name="login">Store Withdrawal</button>
