...
<title>Home Finance | Income</title>
<!-- InstanceEndEditable -->
...
<?php
if(isset($_SESSION['income_message']))
{
echo "<center><b class=alert-info><h4>".$_SESSION['income_message']."</h4></b></center>";
}
?>
...
Salary Amount<input type="text" required name="amount" class="form-control" placeholder="how much salary??"></br>
<button class="alert-danger form-control" type="reset">Reset</button>
<br />
<button class="alert-info  form-control col-lg-10 " type="submit" name="login">Store Income</button>
