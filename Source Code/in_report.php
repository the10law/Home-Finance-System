...
$tdate=$_POST['tdate'];
$fdate=$_POST['fdate'];
$qry="select * from income where date>='$fdate' and date<='$tdate'";
}
if(isset($_POST['mem_butt']))
{
$person=$_POST['person'];
$qry="select * from income where person='$person'";
}
if(isset($_POST['month_butt']))
{
$month=$_POST['month'];
$qry="select * from income where month='$month'";
}
if(isset($_POST['all']))
{
$qry="select * from income";
}
$result1=mysqli_query($con,$qry);
if(!$result1)
echo "<h1><b>Income Record Not Found!!!";
else
{
?>
<div class="container">
